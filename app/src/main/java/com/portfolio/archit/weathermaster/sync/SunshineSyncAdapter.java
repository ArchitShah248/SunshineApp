package com.portfolio.archit.weathermaster.sync;
...
import com.portfolio.archit.weathermaster.MainActivity;
import com.portfolio.archit.weathermaster.R;
import com.portfolio.archit.weathermaster.data.AppConstants;
import com.portfolio.archit.weathermaster.data.AppURLs;
import com.portfolio.archit.weathermaster.database.WeatherContract;
import com.portfolio.archit.weathermaster.muzei.WeatherMuzeiSource;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    public static final String ACTION_DATA_UPDATED = "com.portfolio.archit.weathermaster.ACTION_DATA_UPDATED";
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(AppURLs.FORECAST_BASE_URL).buildUpon()
                    .appendQueryParameter(AppURLs.QUERY_PARAM, locationQuery)
                    .appendQueryParameter(AppURLs.FORMAT_PARAM, format)
                    .appendQueryParameter(AppURLs.UNITS_PARAM, units)
                    .appendQueryParameter(AppURLs.DAYS_PARAM, Integer.toString(numDays))
                    .appendQueryParameter(AppURLs.APPID_PARAM, AppConstants.OPEN_WEATHER_MAP_API_KEY)
                    .build();
            ...
            Log.v(LOG_TAG, "URL: " + url.toString() + " Res: " + forecastJsonStr);
    ...
    private void notifyWeather() {
        ...
        boolean displayNotifications = Utility.isNotificationEnabled(context);
...
// mId allows you to update the notification later on.
    ...
    private static void setLocationStatus(Context context, @SunshineSyncAdapter.LocationStatus int value) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(context.getString(R.string.pref_location_status_key), value);
        editor.commit();
    }
    ...
    private void updateWearable() {
        ...
        Log.d(TAG,"Update wearable called");
        String locationQuery = Utility.getPreferredLocation(getContext());
