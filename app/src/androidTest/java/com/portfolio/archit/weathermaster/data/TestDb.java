...
import com.portfolio.archit.weathermaster.database.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public long insertLocation() {
        ...
        assertTrue("Error: This means that we were unable to query the database for row info.", c.moveToFirst());

        // Move the cursor to a valid database row
        TestUtilities.validateCurrentRecord("Error: No Records returned from location query", c, contentValues);
